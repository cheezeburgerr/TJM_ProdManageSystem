...
export default function Check({ auth, boxes, order, artists, printers }) {
    ...
    const handleFinishButtonClick = () => {
        ...
        const unchecked = lineup.filter(item => item.status !== '1st Check');
    ...
    return (
        ...
        >
            ...
            <h1 className="font-bold text-2xl text-gray-900 mb-8">Check Lineups</h1>
                {message && (
                    <>
                        <Alert color={'success'}>
                            <p>{message}</p>
            ...
            <div className="columns-2 bg-white p-4 rounded-md shadow-md mb-4">
                ...
                <div className="break-inside-avoid-column">
                    <div className="flex items-center space-x-2 mb-4 justify-end">
                        ...
                        <PrimaryButton onClick={changeStatus}>Proceed</PrimaryButton>
